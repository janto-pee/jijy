...
ALTER TABLE "interview" ADD FOREIGN KEY ("interviewer") REFERENCES "employers" ("id");

ALTER TABLE "employers" ADD FOREIGN KEY ("company") REFERENCES "companies" ("id");

ALTER TABLE "interview_applicants" ADD FOREIGN KEY ("applicant_username") REFERENCES "applications" ("username");

ALTER TABLE "interview_applicants" ADD FOREIGN KEY ("interview_id") REFERENCES "interview" ("id");

ALTER TABLE "job_applicants" ADD FOREIGN KEY ("applicant_username") REFERENCES "applications" ("username");

ALTER TABLE "job_applicants" ADD FOREIGN KEY ("job_id") REFERENCES "jobs" ("id");
...
ALTER TABLE "applicant_ratings" ADD FOREIGN KEY ("job_id") REFERENCES "job_applicants" ("applicant_username");

ALTER TABLE "salary" ADD FOREIGN KEY ("id") REFERENCES "jobs" ("salary");

ALTER TABLE "metaData" ADD FOREIGN KEY ("job_id") REFERENCES "jobs" ("id");

ALTER TABLE "applications" ADD FOREIGN KEY ("username") REFERENCES "applicants" ("username");

ALTER TABLE "hasProbationaryPeriod" ADD FOREIGN KEY ("job_id") REFERENCES "jobs" ("id");

ALTER TABLE "applicant_ratings" ADD FOREIGN KEY ("rating_id") REFERENCES "ratings" ("id");
